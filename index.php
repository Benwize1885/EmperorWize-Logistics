...
<body>
    <h1 align='center' style="margin: 15px; color:#27374D;font-weight: bold;font-family:'Times New Roman', Times, serif">EMPEROR WIZE LOGISTICS COMPANY</h1>
    <hr />
    <P align='center' style="font-weight: bold;color:#526D82;font-family:'Times New Roman', Times, serif">The Fastest Courier Service Ever</P>
    <div class="btn-flex">
        <h5><a class="btnNew" href="admin/adminlogin.php">AdminLogin</a></h5>
    </div>
