...
<body bgcolor="#EEE3CB">
    <h5><a href="../index.php" style="float: right; margin-right:50px; color:#9BABB8">BackToHome</a></h5><br>
    <h1 align='center' style="color: #967E76;font-size:30px">Admin Login</h1>
    <h6 align='center' style="color: #212121;font-weight: bold;font-size:15px">Aborishade Ebenezer. O</h6>
